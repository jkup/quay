...
**YOU ARE IN: `quay/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/quay/` (rig root) or other directories
...
**Your mail address:** `quay/polecats/furiosa`
**Your rig:** quay
**Your Witness:** `quay/witness`
...
| Ask Witness for help | `gt mail send quay/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`quay/witness`) when:
...
```bash
gt mail send quay/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
